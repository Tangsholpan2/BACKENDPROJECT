...
infowindow7.open(map,marker7);
 ...
 function render(data){
	  var html = "<div class='commentBox'><div class='leftPaneling'><img src='img/2.png' id='www'/></div><div class='rightPanel'><span>"+data.name+"</span><div class='date'>"+data.date+"</div><p>"+data.body+"</p></div><div class='clear'></div></div>";
	  $('#container').append(html);
 }

 $(document).ready(function(){
	 var coment = [{
	 "name":"Tangsholpan","date":"10 Apr,2021","body":"The best Asian Foods I have tried!!!!!",
	  "name":"John","date":"25 Sep,2019","body":"I found here the best chickens!!!!!"
	 }];
